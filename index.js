    ...
    if (($$43$0 = getChecker(ENode)(t0$0)) && (($$44$0 = ___hasprop(t0$0, "tags")) && (t1$0 = t0$0.tags, Array.isArray(t1$0) && (t2$0 = t1$0.length, t2$0 === 0 && (___hasprop(t0$0, "props") && (props$0 = t0$0.props, ___hasprop(t0$0, "children"))))))) {
      ...
      if ($$44$0 && (tags$0 = t0$0.tags, ___hasprop(t0$0, "props") && (props$1 = t0$0.props, ___hasprop(t0$0, "children")))) {
        children$1 = t0$0.children;return h$0(tags$0.join(""), props$1, (acc$0 = [], temp$0 = null, m$0 = null, (function () {
          ...
          try {
            $2: for (var _iterator = children$1[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              m$0 = _step.value;
              var child$0 = undefined;child$0 = m$0;temp$0 = egh$0(child$0);acc$0.push(temp$0);
            }
          } catch (err) {
        ...
        return ___match_error(ph$0$0, "ENode? {=> tags, => props, => children}");
      }
    }
  }
};footer$0 = function footer(responses$0) {
  return { DOM: Observable$0["return"](egh$0(ENode(["div"], {}, "=== footer ==="))) };
};intent$0 = function intent() {
  var $it$1 = undefined;var $it$0 = undefined;var $it$3 = undefined;var $it$2 = undefined;var DOM$0 = undefined;var m$1$0 = undefined;m$1$0 = arguments[0];if (___hasprop(m$1$0, "DOM")) {
    DOM$0 = m$1$0.DOM;return { firstName$: ($it$0 = DOM$0, $it$1 = $it$0.get("#first-name", "input"), $it$1.map(function (event$0) {
        return event$0.target.value;
      })), lastName$: ($it$2 = DOM$0, $it$3 = $it$2.get("#last-name", "input"), $it$3.map(function (event$1) {
        return event$1.target.value;
      })) };
  } else {
    return ___match_error(m$1$0, "{=> DOM}");
  }
};model$0 = function model(actions$0) {
...
},{"./lib":119,"core-js/shim":208,"regenerator/runtime":209}],119:[function(require,module,exports){
(function (global){
...
},{"./$":141}],121:[function(require,module,exports){
// 0 -> Array#forEach
// 1 -> Array#map
// 2 -> Array#filter
// 3 -> Array#some
...
},{"./$":141,"./$.ctx":129}],122:[function(require,module,exports){
var $ = require('./$');
...
},{"./$":141}],123:[function(require,module,exports){
var $        = require('./$')
...
},{"./$":141,"./$.enum-keys":132}],124:[function(require,module,exports){
var $        = require('./$')
...
module.exports = cof;
},{"./$":141,"./$.wks":159}],125:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
...
},{"./$":141,"./$.assert":122,"./$.ctx":129,"./$.for-of":133,"./$.iter":140,"./$.iter-define":138,"./$.mix":143,"./$.uid":157}],126:[function(require,module,exports){
...
},{"./$.def":130,"./$.for-of":133}],127:[function(require,module,exports){
'use strict';
var $         = require('./$')
  , safe      = require('./$.uid').safe
  , assert    = require('./$.assert')
...
},{"./$":141,"./$.array-methods":121,"./$.assert":122,"./$.for-of":133,"./$.mix":143,"./$.uid":157}],128:[function(require,module,exports){
'use strict';
var $     = require('./$')
  , $def  = require('./$.def')
...
},{"./$":141,"./$.assert":122,"./$.cof":124,"./$.def":130,"./$.for-of":133,"./$.iter":140,"./$.iter-detect":139,"./$.mix":143,"./$.redef":146,"./$.species":151}],129:[function(require,module,exports){
...
},{"./$.assert":122}],130:[function(require,module,exports){
var $          = require('./$')
  , global     = $.g
  , core       = $.core
...
module.exports = $def;
},{"./$":141,"./$.redef":146}],131:[function(require,module,exports){
var $        = require('./$')
  , document = $.g.document
  , isObject = $.isObject
...
},{"./$":141}],132:[function(require,module,exports){
var $ = require('./$');
module.exports = function(it){
  var keys       = $.getKeys(it)
    , getDesc    = $.getDesc
...
},{"./$":141}],133:[function(require,module,exports){
var ctx  = require('./$.ctx')
...
},{"./$.ctx":129,"./$.iter":140,"./$.iter-call":137}],134:[function(require,module,exports){
module.exports = function($){
  $.FW   = true;
  $.path = $.g;
  return $;
...
},{"./$":141}],136:[function(require,module,exports){
// Fast apply
...
call.close = close;
module.exports = call;
},{"./$.assert":122}],138:[function(require,module,exports){
var $def            = require('./$.def')
  , $redef          = require('./$.redef')
  , $               = require('./$')
  , cof             = require('./$.cof')
...
},{"./$":141,"./$.cof":124,"./$.def":130,"./$.iter":140,"./$.redef":146,"./$.wks":159}],139:[function(require,module,exports){
...
},{"./$.wks":159}],140:[function(require,module,exports){
'use strict';
var $                 = require('./$')
  , cof               = require('./$.cof')
  , classof           = cof.classof
...
},{"./$":141,"./$.assert":122,"./$.cof":124,"./$.shared":150,"./$.wks":159}],141:[function(require,module,exports){
'use strict';
...
},{"./$.fw":134}],142:[function(require,module,exports){
var $ = require('./$');
...
},{"./$":141}],143:[function(require,module,exports){
...
},{"./$":141,"./$.assert":122}],145:[function(require,module,exports){
'use strict';
var $      = require('./$')
...
},{"./$":141,"./$.assert":122,"./$.invoke":136}],146:[function(require,module,exports){
var $   = require('./$')
...
},{"./$":141,"./$.uid":157}],147:[function(require,module,exports){
'use strict';
...
},{"./$":141,"./$.assert":122,"./$.ctx":129}],150:[function(require,module,exports){
var $      = require('./$')
...
},{"./$":141}],151:[function(require,module,exports){
var $       = require('./$')
...
},{"./$":141,"./$.wks":159}],152:[function(require,module,exports){
// true  -> String#at
...
},{"./$":141}],153:[function(require,module,exports){
...
},{"./$":141,"./$.string-repeat":154}],154:[function(require,module,exports){
'use strict';
var $ = require('./$');
...
},{"./$":141}],155:[function(require,module,exports){
'use strict';
var $      = require('./$')
  , ctx    = require('./$.ctx')
  , cof    = require('./$.cof')
...
},{"./$":141,"./$.cof":124,"./$.ctx":129,"./$.dom-create":131,"./$.invoke":136}],156:[function(require,module,exports){
module.exports = function(exec){
  try {
    exec();
    return false;
...
module.exports = uid;
},{"./$":141}],158:[function(require,module,exports){
...
},{"./$":141,"./$.wks":159}],159:[function(require,module,exports){
...
},{"./$":141,"./$.shared":150,"./$.uid":157}],160:[function(require,module,exports){
var $                = require('./$')
  , cel              = require('./$.dom-create')
  , cof              = require('./$.cof')
  , $def             = require('./$.def')
...
},{"./$":141,"./$.array-includes":120,"./$.array-methods":121,"./$.assert":122,"./$.cof":124,"./$.def":130,"./$.dom-create":131,"./$.invoke":136,"./$.replacer":147,"./$.throws":156,"./$.uid":157}],161:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":141,"./$.def":130,"./$.unscope":158}],162:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":141,"./$.def":130,"./$.unscope":158}],163:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":121,"./$.def":130,"./$.unscope":158}],164:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":121,"./$.def":130,"./$.unscope":158}],165:[function(require,module,exports){
var $     = require('./$')
  , ctx   = require('./$.ctx')
  , $def  = require('./$.def')
  , $iter = require('./$.iter')
...
},{"./$":141,"./$.ctx":129,"./$.def":130,"./$.iter":140,"./$.iter-call":137,"./$.iter-detect":139}],166:[function(require,module,exports){
var $          = require('./$')
...
setUnscope('values');
setUnscope('entries');
},{"./$":141,"./$.iter":140,"./$.iter-define":138,"./$.uid":157,"./$.unscope":158}],167:[function(require,module,exports){
var $def = require('./$.def');
$def($def.S, 'Array', {
...
},{"./$.def":130}],168:[function(require,module,exports){
require('./$.species')(Array);
},{"./$.species":151}],169:[function(require,module,exports){
var $             = require('./$')
...
},{"./$":141,"./$.wks":159}],170:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , NAME = 'name'
  , setDesc = $.setDesc
...
},{"./$":141}],171:[function(require,module,exports){
'use strict';
...
},{"./$.collection":128,"./$.collection-strong":125}],172:[function(require,module,exports){
var Infinity = 1 / 0
  , $def  = require('./$.def')
  , E     = Math.E
  , pow   = Math.pow
...
},{"./$.def":130}],173:[function(require,module,exports){
'use strict';
var $          = require('./$')
  , isObject   = $.isObject
  , isFunction = $.isFunction
...
},{"./$":141,"./$.redef":146}],174:[function(require,module,exports){
var $     = require('./$')
  , $def  = require('./$.def')
  , abs   = Math.abs
  , floor = Math.floor
...
},{"./$":141,"./$.def":130}],175:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');
$def($def.S, 'Object', {assign: require('./$.assign')});
},{"./$.assign":123,"./$.def":130}],176:[function(require,module,exports){
// 19.1.3.10 Object.is(value1, value2)
var $def = require('./$.def');
$def($def.S, 'Object', {
  is: require('./$.same')
});
},{"./$.def":130,"./$.same":148}],177:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $def = require('./$.def');
$def($def.S, 'Object', {setPrototypeOf: require('./$.set-proto').set});
},{"./$.def":130,"./$.set-proto":149}],178:[function(require,module,exports){
var $        = require('./$')
  , $def     = require('./$.def')
  , isObject = $.isObject
  , toObject = $.toObject;
...
},{"./$":141,"./$.def":130,"./$.get-names":135}],179:[function(require,module,exports){
'use strict';
...
},{"./$":141,"./$.cof":124,"./$.redef":146,"./$.wks":159}],180:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
  , cof      = require('./$.cof')
...
},{"./$":141,"./$.assert":122,"./$.cof":124,"./$.ctx":129,"./$.def":130,"./$.for-of":133,"./$.iter-detect":139,"./$.mix":143,"./$.same":148,"./$.set-proto":149,"./$.species":151,"./$.task":155,"./$.uid":157,"./$.wks":159}],181:[function(require,module,exports){
var $         = require('./$')
  , $def      = require('./$.def')
...
},{"./$":141,"./$.assert":122,"./$.def":130,"./$.iter":140,"./$.own-keys":144,"./$.set-proto":149,"./$.uid":157,"./$.wks":159}],182:[function(require,module,exports){
var $       = require('./$')
  , cof     = require('./$.cof')
  , $RegExp = $.g.RegExp
  , Base    = $RegExp
...
},{"./$":141,"./$.cof":124,"./$.redef":146,"./$.replacer":147,"./$.species":151}],183:[function(require,module,exports){
'use strict';
var strong = require('./$.collection-strong');
...
},{"./$.collection":128,"./$.collection-strong":125}],184:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":130,"./$.string-at":152}],185:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def')
...
},{"./$":141,"./$.cof":124,"./$.def":130,"./$.throws":156}],186:[function(require,module,exports){
var $def    = require('./$.def')
...
},{"./$":141,"./$.def":130}],187:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":141,"./$.cof":124,"./$.def":130}],188:[function(require,module,exports){
var set   = require('./$').set
...
},{"./$":141,"./$.iter":140,"./$.iter-define":138,"./$.string-at":152,"./$.uid":157}],189:[function(require,module,exports){
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":141,"./$.def":130}],190:[function(require,module,exports){
var $def = require('./$.def');
...
},{"./$.def":130,"./$.string-repeat":154}],191:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":141,"./$.cof":124,"./$.def":130,"./$.throws":156}],192:[function(require,module,exports){
'use strict';
...
},{"./$":141,"./$.assert":122,"./$.cof":124,"./$.def":130,"./$.enum-keys":132,"./$.get-names":135,"./$.keyof":142,"./$.redef":146,"./$.shared":150,"./$.uid":157,"./$.wks":159}],193:[function(require,module,exports){
'use strict';
var $         = require('./$')
...
},{"./$":141,"./$.collection":128,"./$.collection-weak":127,"./$.redef":146}],194:[function(require,module,exports){
'use strict';
...
},{"./$.collection":128,"./$.collection-weak":127}],195:[function(require,module,exports){
'use strict';
var $def      = require('./$.def')
...
},{"./$.array-includes":120,"./$.def":130,"./$.unscope":158}],196:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Map');
},{"./$.collection-to-json":126}],197:[function(require,module,exports){
...
},{"./$":141,"./$.def":130,"./$.own-keys":144}],198:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":141,"./$.def":130}],199:[function(require,module,exports){
...
},{"./$.def":130,"./$.replacer":147}],200:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Set');
},{"./$.collection-to-json":126}],201:[function(require,module,exports){
...
},{"./$.def":130,"./$.string-at":152}],202:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":130,"./$.string-pad":153}],203:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
  , $pad = require('./$.string-pad');
$def($def.P, 'String', {
...
},{"./$.def":130,"./$.string-pad":153}],204:[function(require,module,exports){
...
},{"./$":141,"./$.ctx":129,"./$.def":130}],205:[function(require,module,exports){
...
},{"./$":141,"./$.iter":140,"./$.wks":159,"./es6.array.iterator":166}],206:[function(require,module,exports){
var $def  = require('./$.def')
  , $task = require('./$.task');
$def($def.G + $def.B, {
...
},{"./$.def":130,"./$.task":155}],207:[function(require,module,exports){
...
},{"./$":141,"./$.def":130,"./$.invoke":136,"./$.partial":145}],208:[function(require,module,exports){
require('./modules/es5');
...
},{"./modules/$":141,"./modules/es5":160,"./modules/es6.array.copy-within":161,"./modules/es6.array.fill":162,"./modules/es6.array.find":164,"./modules/es6.array.find-index":163,"./modules/es6.array.from":165,"./modules/es6.array.iterator":166,"./modules/es6.array.of":167,"./modules/es6.array.species":168,"./modules/es6.function.has-instance":169,"./modules/es6.function.name":170,"./modules/es6.map":171,"./modules/es6.math":172,"./modules/es6.number.constructor":173,"./modules/es6.number.statics":174,"./modules/es6.object.assign":175,"./modules/es6.object.is":176,"./modules/es6.object.set-prototype-of":177,"./modules/es6.object.statics-accept-primitives":178,"./modules/es6.object.to-string":179,"./modules/es6.promise":180,"./modules/es6.reflect":181,"./modules/es6.regexp":182,"./modules/es6.set":183,"./modules/es6.string.code-point-at":184,"./modules/es6.string.ends-with":185,"./modules/es6.string.from-code-point":186,"./modules/es6.string.includes":187,"./modules/es6.string.iterator":188,"./modules/es6.string.raw":189,"./modules/es6.string.repeat":190,"./modules/es6.string.starts-with":191,"./modules/es6.symbol":192,"./modules/es6.weak-map":193,"./modules/es6.weak-set":194,"./modules/es7.array.includes":195,"./modules/es7.map.to-json":196,"./modules/es7.object.get-own-property-descriptors":197,"./modules/es7.object.to-array":198,"./modules/es7.regexp.escape":199,"./modules/es7.set.to-json":200,"./modules/es7.string.at":201,"./modules/es7.string.lpad":202,"./modules/es7.string.rpad":203,"./modules/js.array.statics":204,"./modules/web.dom.iterable":205,"./modules/web.immediate":206,"./modules/web.timers":207}],209:[function(require,module,exports){
(function (process,global){
/**
